package com.activemesa.creational.decorator;
...
public class MagicString {
    ...
    /**
     * This is a new method we wanted to add to String class.
     * @return
     */
    ...
    // We can delegate all methods from String class
    // For this, on Intelij, select option Delegate Method, select String class and delegate all methods.
    public int length() {
