package com.activemesa.creational.decorator.adapterdecorator;

import java.util.stream.IntStream;

/**
 * This is a way to do merge between Adapter and Decorator patterns.
 * Decorator provides additional functionalities while Adapter tries to mimic some interfaces or make some things easy.
 */
public class MyStringBuilder {
    ...
    /**
     * We will use the same concat functionality from string and add to our class.
     *
     * @param str
     * @return
     */
...
class Demo {
    public static void main(String[] args) {
        final MyStringBuilder msb = new MyStringBuilder();
