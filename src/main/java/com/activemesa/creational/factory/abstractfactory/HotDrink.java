package com.activemesa.creational.factory.abstractfactory;
...
/**
 * Abstract factory pattern is not very common, but there might be some cases where they can be used
 * It is a pattern that makes the correspondence between the hierarchy of objects and hierarchy of factories to
 * construct those objects.
 */
...
class HotDrinkMachine {
    ...
    /**
     * Find implementers of HotDrinkFactory, using reflection
     */
        ...
        while(true) {
            ...
            if((s = reader.readLine()) != null && (i = Integer.parseInt(s)) >= 0 && (i < namedFactories.size())) {
                ...
                if(s != null && (amount = Integer.parseInt(s)) > 0) {
                    namedFactories.get(i).getValue().prepare(amount);
                }
            }
